...
public class JsonTool {
	...
	public static String jsonToDisplay(String simpleJsonStr) {
		if (StringUtils.isBlank(simpleJsonStr)) {
			return "";
		}
	...
	public static <T> T fromJson(String json, Class<T> clazz, ObjectMapper mapper) {
		...
		try {
			...
			throw  new RuntimeException("json解析为对象出错！json"+ json);
		}
	}
	 ...
	 * @time 2013-2-7 下午8:46:57
	 */
	public static <T> T fromJson(String json, TypeReference<T> typeReference, ObjectMapper mapper) {
		if(StringUtils.isBlank(json)) {
			return null;
		}
		if(mapper == null) {
...
//			LOG.error(e, "反序列化json串出错:" + jsonString);
	 ...
	 * @time 2013-2-7 下午8:56:00
	 */
	public static <T> T fromJson(File jsonFile, TypeReference<T> typeReference) {
...
//			LOG.error(e, "json解析为对象出错！");
	 ...
	 * @time 2013-2-7 下午8:56:00
	 */
	public static <T> T fromJson(File jsonFile, TypeReference<T> typeReference, ObjectMapper mapper) {
		if(mapper == null) {
			mapper = createDefaultMapper();
		}
		try {
