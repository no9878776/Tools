...
//        return DigestTool.getMD5(str, saltStr);
//    }
//
//    /**
//     * <p>
...
//     * @return 替换后的字符串
//     */
//    public static String fillTemplate(String template, Map<String, String> paramMap) {
//        if (template == null) {
//            return "";
//        }
...
//            template = template.replaceAll("\\$\\{" + paramName + "\\}", Matcher.quoteReplacement(paramValue));
//        }
//        return template;
//    }
//
...
//     * @return 替换后的字符串
//     */
//    public static String fillTemplateByObjectMap(String template, Map<String, Object> paramMap) {
//        if (template == null) {
//            return "";
//        }
//        if (MapTool.isEmpty(paramMap)) {
...
//            String paramName = entry.getKey();
//            String paramValue = entry.getValue() == null ? "" : String.valueOf(entry.getValue());
//            template = template.replaceAll("\\$\\{" + paramName + "\\}", Matcher.quoteReplacement(paramValue));
//        }
//        return template;
//    }
//
//
//    public static String matchTemplate(String template, String source) {
//        return matchTemplate(template, source, 1);
//    }
//
//    public static String matchTemplate(String template, String source, int groupId) {
...
//     * StringUtils.join(',', 1, 1, [null])             = ""
//     * StringUtils.join(';', 1, 3, ["a", "b", "c"])  = "b;c"
//     * </pre>
//     *
//     * @param separator  分隔符
...
//     * @since 1.0.0
//     */
//    public static String join(char separator, int startIndex, int endIndex, Object... array) {
...
//     * @since 1.0.0
//     */
//    public static String join(String separator, int startIndex, int endIndex, Object... array) {
//        return org.apache.commons.lang3.StringUtils.join(array, separator, startIndex, endIndex);
//    }
//
//    /**
...
//     * @see org.soul.commons.lang.string.StringTool#defaultString(String, String)
//     * @since 1.0.0
//     */
...
//     * @return
//     */
//    public static String overlayString(String str) {
//        if (isBlank(str)) {
//            return "";
//        }
//        if (str.length() < 5) {
//            return str.substring(0, str.length() / 2).concat("****").concat(str.substring(str.length() / 2));
//        }
//        return overlay(str, "****", 2, str.length() - 2);
//    }
//
//    /**
//     * 隐藏电话部分内容
...
//     * @return
//     */
//    public static String overlayTel(String tel) {
//        if (isBlank(tel)) {
//            return "";
//        }
//        return overlay(tel, "****", 3, tel.length() - 3);
//    }
//
//    /**
//     * 隐藏邮件部分内容
...
//     * @return
//     */
//    public static String overlayEmail(String email) {
//        if (isBlank(email)) {
//            return "";
//        }
//        return overlay(email, "****", 3, email.indexOf("@"));
//    }
//
//    /**
//     * 隐藏姓名部分内容
...
//     * @return
//     */
//    public static String overlayName(String name) {
//        if (isBlank(name)) {
//            return "";
//        }
//        if (name.length() == 1) {
//            return name;
//        }
//        return overlay(name, "*", 1, name.length() == 2 ? 2 : name.length() - 1);
//    }
//
//    /**
//     * 隐藏部分ip方法,类似：127.**.**.1
...
//     * @return
//     */
//    public static String overlayIp(String ip) {
//        if (isBlank(ip)) {
//            return "";
//        }
//        ip = overlay(ip, "**", ip.indexOf(".") + 1, ordinalIndexOf(ip, ".", 2));
//        return overlay(ip, "**", ordinalIndexOf(ip, ".", 2) + 1, ordinalIndexOf(ip, ".", 3));
//    }
//
//    /**
//     * 把对象转化成字符串
...
//     * @return
//     */
//    public static String objectToTrimEmpty(Object object) {
//        if (object == null)
//            return "";
//        return trimToEmpty(object.toString());
//    }
//
//    /**
//     * 把对象转化成字符串
...
//     * @return
//     */
//    public static String objectToTrimEmpty(Object object, String defaultValue) {
//        if (object == null)
...
//
//    /**
//     * 去除所有html or xml相关标记性文本内容
//     * @param source
//     * @return
//     */
//    public static String replaceHtml(String source) {
//        if (org.soul.commons.lang.string.StringTool.isBlank(source))  {
//            return source;
//        }
